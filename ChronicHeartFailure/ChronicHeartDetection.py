...
main = tkinter.Tk()
main.title("DETECTION OF CHRONIC HEART FAILURE FROM HEART SOUNDS USING RFAM")
...
font = ('times', 14, 'bold')
title = Label(main, text='DETECTION OF CHRONIC HEART FAILURE FROM HEART SOUNDS USING RFAM  ')
